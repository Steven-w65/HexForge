...
<style scoped>
.top-menu { position: relative; display: flex; align-items: center; height: 28px; padding: 0 8px; background: var(--surface); border-bottom: 1px solid var(--border); }
.menu-brand { display: flex; align-items: center; gap: 7px; margin-right: 16px; white-space: nowrap; font-size: 11px; letter-spacing: .02em; }
.brand-mark { display: grid; place-items: center; width: 20px; height: 20px; color: var(--selection-text); background: var(--selection); border-radius: 4px; font-size: 9px; font-weight: 700; }
.top-menu > button { height: 23px; padding: 0 9px; color: var(--muted); background: transparent; border: 0; border-radius: 3px; font: inherit; font-size: 10px; text-transform: none; }
.top-menu > button:hover, .top-menu > button[aria-expanded='true'] { color: var(--text); background: var(--hover); }
.menu-popup { position: absolute; z-index: 20; top: 27px; display: grid; min-width: 245px; padding: 4px; color: var(--text); background: var(--panel); border: 1px solid var(--border-strong); border-radius: 4px; box-shadow: 0 8px 20px rgb(0 0 0 / 24%); }
.menu-item { display: grid; grid-template-columns: 14px minmax(120px, 1fr) auto; align-items: center; min-height: 26px; gap: 6px; padding: 0 7px; color: var(--text); background: transparent; border: 0; border-radius: 3px; font: inherit; font-size: 10px; text-align: left; }
...
kbd { color: var(--muted); font: inherit; font-size: 9px; }
.separator { height: 1px; margin: 4px 3px; background: var(--border); }
.submenu-flyout { position: absolute; left: calc(100% + 4px); display: grid; min-width: 220px; max-height: 260px; padding: 4px; overflow: auto; color: var(--text); background: var(--panel); border: 1px solid var(--border-strong); border-radius: 4px; box-shadow: 0 8px 20px rgb(0 0 0 / 24%); }
